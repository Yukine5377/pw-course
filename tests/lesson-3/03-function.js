// Tạo file 03-function.js và thêm vào lời giải cho các bài sau:
// 1. Viết hàm multiply nhận 2 tham số a và b, in ra kết quả nhân của chúng. Gọi hàm với
// 2 cặp giá trị khác nhau.
function multiply(a, b) {
  return a * b;
}
const ketqua1 = multiply(4, 7);
const ketqua2 = multiply(4, 9);
...
const HocSinhGioi = getTopStudents(students,200)
...
console.log(calculateInterest(100,0.2,10))
